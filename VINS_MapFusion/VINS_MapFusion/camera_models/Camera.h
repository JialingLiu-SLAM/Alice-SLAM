...
//
        ...
        virtual void readFromYamlFile(int m_imageWidth,int m_imageHeight,double k1_global,double k2_global,double p1_global,double p2_global,double FOCUS_LENGTH_X_server,double FOCUS_LENGTH_Y_server,double PX_server,double PY_server){}
    protected:
