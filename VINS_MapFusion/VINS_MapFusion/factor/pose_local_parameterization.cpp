...
bool PoseQ_LocalParameterization::Plus(const double *x, const double *delta, double *x_plus_delta) const
{
...
bool PoseQ_LocalParameterization::ComputeJacobian(const double *x, double *jacobian) const
{
