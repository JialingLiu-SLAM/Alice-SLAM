...
{
	// Just pass through
	return encodeImageMono(kptsLeft, descriptorsLeft, point_clouds, bitstream );
}
...
{
    decodeImageMono( bitstream, keypoints, descriptors, visualWords );
...
//    des_d_sum+=des_d;
//    mCurrentImageId++;
//    cout<<"数据库累积描述符的差别量："<<des_d_sum*1.0/mCurrentImageId<<endl;
